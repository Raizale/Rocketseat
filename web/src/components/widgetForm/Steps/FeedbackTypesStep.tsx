...
interface FeedbackTypesStepProps {
    onFeedbackTypesChange: (type:FeedbackType) => void;
    
}

export function FeedbackTypesStep({onFeedbackTypesChange}: FeedbackTypesStepProps){
    return(
        <>
        <header>
        ...
        { Object.entries(feedbackTypes).map(([key, value]) =>{
            return (
                ...
                key={key}
                    ...
                    onClick={() => onFeedbackTypesChange(key as FeedbackType)}
                    type='button'
